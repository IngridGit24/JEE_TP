 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://TP1.market.com/", wsdlLocation = "http://localhost:2000/BanqueService?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUESERVICESERVICE_QNAME = new QName("http://TP1.market.com/", "BanqueServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:2000/BanqueService?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://TP1.market.com/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://TP1.market.com/", "BanqueServicePort"), BanqueService.class, features);
    }
